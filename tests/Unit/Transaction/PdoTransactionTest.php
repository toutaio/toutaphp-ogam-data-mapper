...
final class PdoTransactionTest extends TestCase
{
    ...
    {
        $transaction = new PdoTransaction($this->connection, autoCommit: true);
    ...
    {
        $transaction = new PdoTransaction($this->connection, autoCommit: false);
    ...
    public function testConstructorWithIsolationLevel(): void
    {
        ...
        $transaction = new PdoTransaction($this->connection, 2, false);
    ...
    {
        $transaction = new PdoTransaction($this->connection, null, false);
